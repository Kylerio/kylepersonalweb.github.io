...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_zo95i6j', 'template_txmfh26', form.current, {
        publicKey: 'UHixbEgTHxQxrwrxK',
      })
      e.target.reset()
  };
        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">barakhyelrio18@gmail.com</span>

              <a href="mailto:barakhyelrio18@gmail.com" className="contact_button">
                Write me{" "}
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">+62 896-3610-4481</span>

              <a href="https://wa.me/6289636104481" className="contact_button">
                Write me{" "}
                <i className="bx bx-right-arrow-alt contact_button-icon"></i>
              </a>
            </div>
